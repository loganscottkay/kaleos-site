/* Structured data so search engines and AI assistants describe Kaleos HQ the
...
export const organization = {
  ...
  description: 'A premium AI implementation practice. Kaleos HQ designs and ships custom AI systems for businesses, with a person approving every consequential step.',
...
export const service = {
  ...
  provider: { '@type': 'Organization', name: 'Kaleos HQ', url: 'https://www.kaleoshq.com' },
